...
namespace WebApiTest.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(AppDbContext apiDbContext ,IUserService userService, ILogger<UsersController> logger, IConfiguration configuration)
        {
        ...
        [HttpGet("[action]")]
        public IActionResult UserLogin([FromQuery] string UserEmail, string UserPassword)
        {
            var result = _appDbContext.Users.FirstOrDefault(x => x.Email == UserEmail && x.Password == UserPassword);
            if (result == null)
            {
                return NotFound();
            }
