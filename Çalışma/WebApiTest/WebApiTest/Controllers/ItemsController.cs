...
namespace WebApiTest.Controllers
{
    ...
    public class ItemsController : ControllerBase
    {
        ...
        public List<Item> GetItemsCategoryId(int categoryId)
        {
            List<Item> items = _itemService.GetItemsByCategoryId(categoryId);

            List<Item> itemsByCategoryId = items.Select(item => new Item
            {
                Id = item.Id,
                CategoryId = item.CategoryId,
                SubCategoryId = item.SubCategoryId,
